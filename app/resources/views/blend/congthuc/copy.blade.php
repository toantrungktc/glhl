...
@section('diachi')
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item">Copy</li>
			...
			<div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control" id="sothongbao" name="sothongbao" placeholder="Số văn bản" >
                    </div>
                            
                    <label for="noidung">Ngày</label>
                    <div>
                        <input type="date" class="form-control" id="ngay_thongbao" name="ngay_thongbao" placeholder="Số văn bản liên quan" >
                    </div>
                </div>    
