...
@section('diachi')
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item">Blend</li>
        ...
        <div class="col-12 ">
		    ...
		    <div class="card card-primary sticky-top" style="top: 58px">
				<div class="card-header">
					...
					@role('admin')
						<a class="float-left" href="{{ url('blend/trash') }}" role="button">&nbsp;&nbsp;&nbsp;&nbsp; <i class="fas fa-trash-alt"></i></a>
						<a class="float-left" href="{{ url('blend/log') }}" role="button">&nbsp;&nbsp;&nbsp;&nbsp; <i class="fas fa-history"></i></a>					
					@endrole
					@can('add congthuc')
		    ...
		    <div class="card card-primary" style="top: -20px">
				<div class="card-body">
					<table id="blend" class="table table-bordered table-striped">
						<thead>
							<tr>
							    <th>No</th>
							    <th>Blend</th>
...
<script>
	$(function () {
		...
		table.buttons().container().appendTo('#blend_wrapper .col-md-6:eq(0)');
	});
</script>
...
<script>
	$(document).ready(function () {
		...
		$('body').on('click', '#edit-key', function () {
			...
			$.get('blend/edit/'+blend_id, function (data) {
