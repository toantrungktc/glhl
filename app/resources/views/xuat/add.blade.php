...
<script>
    $(document).ready(function(){
        ...
        '</select>'+'</td><td><input type="number" step="any" name="tyle[]" class="form-control" value="" /></td><td><button id="delete" onclick="doSomething('+rowCount2+')">Xoá</button></td></tr>';
	...
	$(function() {
		$('#kl_la').on('change', function(){
            ...
            for(i=0;i<=rowCount2;i++){
                ...
                var kl = (khoiluong*tyle)/100).toFixed(2);
                $('#gl_row_id_'+i).val();
