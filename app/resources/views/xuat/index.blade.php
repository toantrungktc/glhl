        ...
        <div class="col-12 ">
		    ...
		    <div class="card card-primary sticky-top" style="top: 58px">
				<div class="card-header">
					...
					@role('admin')
						<a class="float-left" href="{{ url('xuat/trash') }}" role="button">&nbsp;&nbsp;&nbsp;&nbsp; <i class="fas fa-trash-alt"></i></a>
						<a class="float-left" href="{{ url('xuat/log') }}" role="button">&nbsp;&nbsp;&nbsp;&nbsp; <i class="fas fa-history"></i></a>
					@endrole
					@can('add xuat')
		    ...
		    <div class="card card-primary" style="top: -20px">
				<div class="card-body">
					<table id="xuat" class="table table-bordered table-striped">
						<thead>
							<tr>
							    <th>No</th>
							    <th>Tên Sản phẩm</th>
...
<script>
	$(function () {
		...
		table.buttons().container().appendTo('#xuat_wrapper .col-md-6:eq(0)');
	});
</script>
...
<script>
	$(document).ready(function () {
		...
		$('body').on('click', '#delete-xuat', function () {
			var xuat_id = $(this).data("id");
			if(confirm("Are You sure want to delete !")){
				$.ajax({
					type: "DELETE",
					url: "{{ url('xuat/delete/')}}"+'/'+xuat_id,
					type: "GET",
					success: function (data) {
						$('#xuat').DataTable().ajax.reload(null, false);
					},
					error: function (data) {
